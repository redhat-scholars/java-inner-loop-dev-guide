...
If you add the above variables to this lab url you will end up with something like this: link:{site-url}?USERNAME=developer&PASSWORD=developer&CLUSTER_SUBDOMAIN=apps-crc.testing#lab-parameters[{site-url}?USERNAME=developer&PASSWORD=developer&CLUSTER_SUBDOMAIN=apps-crc.testing, window=_blank]
