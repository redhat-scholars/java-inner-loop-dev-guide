...
IMPORTANT: Choose a folder to put the code into and stick to it till the end of the guide. All paths are relative to this folder.
...
NOTE: As usual you can find those profiles at: `src/main/resources`.
...
NOTE: You can find import files here: `src/main/resources`.
...
Now you can stop the process with kbd:[Ctrl+C] and go on with the lab.